...
import { Box, List, ListItem, Paper, InputLabel, MenuItem, FormControl, Select, styled, Typography } from '@mui/material';
...
const ExerciseTracker = () => {
    ...
    return (
        <StyledRoot className="exerciseTracker">
            <Navbar />
            <Box sx={{ padding: 2 }}>
                <Typography variant="h6" className="moreSpace">View Your Exercises Today:</Typography>
                ...
                <Box sx={{ minWidth: 120, mt: 2 }} className="button">
